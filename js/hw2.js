function mathoperations() {
    ...
    if (isNaN(num1) || isNaN(num2) || isNaN(num3)) {
        document.getElementById("num1error").innerHTML = isNaN(num1) ? "number 1 must contain a numeric value!" : "";
        document.getElementById("num2error").innerHTML = isNaN(num2) ? "number 2 must contain a numeric value!" : "";
        document.getElementById("num3error").innerHTML = isNaN(num3) ? "number 3 must contain a numeric value!" : "";
    } else {
        ...
        document.getElementById("product").innerHTML = product.toLocaleString();
...
function calcrates() {
    ...
    if (isNaN(usd)) {
        ...
        let yen = usd * 156.73;
        let peso = usd * 18.41;
        document.getElementById("euro").innerHTML = euro.toLocaleString("en-GB", {style:"currency", currency:"EUR"});
        document.getElementById("cand").innerHTML = cand.toLocaleString("en-CA", {style:"currency", currency:"CAD"});
        document.getElementById("hkd").innerHTML = hkd.toLocaleString("zh-HK", {style:"currency", currency:"HKD"});
        document.getElementById("yen").innerHTML = yen.toLocaleString("ja-JP", {style:"currency", currency:"JPY"});
        document.getElementById("peso").innerHTML = peso.toLocaleString("es-MX", {style:"currency", currency:"MXN"});
